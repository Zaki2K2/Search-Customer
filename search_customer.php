...
<title> CCMS | Search Customer</title>
<?php
...
<div class="main-content">
        ...
        <div class="barr">
            <h1> <a href="search_customer.php"> Search Customer </a></h1>
            <nav>
        ...
        <div class="container">
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="search" name="search" placeholder="Enter Customer's ID or Customer's Name" required>
                </div>
            ...
            <?php
                if (isset($_POST['submit'])) {
                    ...
                    WHERE user_type_id = 4 AND (id LIKE '%$search%' OR name LIKE '%$search%')");
                                        ...
                                        while ($row = mysqli_fetch_array($query)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    class="badge badge-info" style="font-size: 15px; background-color: #f39c12; color: #2c3e50; margin: 5px;">View Details</a>

                                                    <a href="customer_complaints.php?id=<?php echo htmlentities($row['id']); ?>"
                                                    class="badge badge-info" style="font-size: 15px; background-color: #2f3640; color: #f4ebe8; margin: 5px;">Complaints</a>
                                                </td>
                                            </tr>
                                            <?php
                                            $cnt++;
